package com.example.fyp.classifier;
...
public class ImageClassifier {
    ...
    public ImageClassifier(Activity activity) throws IOException {
        ...
        int[] inputImagesShape = tensorClassifier.getInputTensor(imageTensorIndex).shape();
        ...
        imageResizeX = inputImagesShape[1];
        imageResizeY = inputImagesShape[2];
    ...
    public List<Recognition> recognizeImage(final Bitmap bitmap, final int sensorOrientation){
        ...
        // sorting predicitions based on confidence
